...
namespace Drupal\Tests\marvin_composer_product\Helper;
...
class ComposerScripts {
  ...
  protected function prepareProjectComposerJson() {
    $content = [
      'name' => 'drupal/marvin-composer-product-tests-project_01',
      'description' => 'drupal/marvin-composer-product-tests-project_01',
      "license" => "proprietary",
      'type' => 'drupal-project',
      'extra' => [
        'installer-types' => [
...
TEXT;
  ...
  protected function getProjectSelfFilesToSymlink(): array {
    ...
    $filesToSymLink = $extra['marvin_composer_product']['fixtures']['filesToSymlink'] ?? [];
